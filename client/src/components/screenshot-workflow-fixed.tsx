...
export default function ScreenshotWorkflowFixed({ canUseFeature, onAnalyze }: ScreenshotWorkflowProps) {
  ...
  const addLeftRightPrefixes = (text: string): string => {
    ...
    lines.forEach((line, index) => {
      ...
      // Alternate between Left and Right based on position/layout
      // This is a simple heuristic - in a real app you'd use more sophisticated text positioning
      const isLeftSide = index % 2 === 0; // Simple alternation for demo
