        ...
        <body>
          <div class="drama-llama-document">
            <div class="document-header">
              <div class="logo-container" style="text-align:center; margin: 10px 0;">
                <!-- Using plain text instead of an image -->
                <div style="display:inline-block; width:80px; height:80px; background-color:#FF69B4; border-radius:50%; color:white; font-weight:bold; text-align:center; line-height:35px; padding-top:10px;">
                  Drama<br>Llama
